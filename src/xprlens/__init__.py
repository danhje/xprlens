"""Plotly reports and interactive 2D slices for FICO Xpress problems.
...
from .explorer import slice_explorer
...
__all__ = ["ALL_SECTIONS", "MATRIX_SECTIONS", "__version__", "report", "slice_explorer"]
